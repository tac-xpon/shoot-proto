...
pub const NUM_SP_PALETTE_TBL: usize = 1;
pub const NUM_SP_PALETTE_COL: usize = 128;
...
pub static COLOR_TBL: [[Rgba<u8>; NUM_PALETTE_COL]; NUM_PALETTE_TBL] = {
    ...
    while tbl_no < NUM_SP_PALETTE_TBL {
        let mut idx = 0;
        while idx < NUM_SP_PALETTE_COL {
            let (r, g, b, a) = SP_PALS[tbl_no][idx];
...
const SP_PALS: [[(u8, u8, u8, u8); NUM_SP_PALETTE_COL]; NUM_SP_PALETTE_TBL] = [
    [
        (  0,   0,   0,   0),
        ( 60,  74, 176, 128),
        (152,   6,   6, 128),
